  ...
  useEffect(() => {
    ...
    const fragmentShaderSource = `
      ...
      vec3 palette(float t) {
        ...
        vec3 d = vec3(0.0, 0.33, 0.67); // Shifts palette heavily into blues
      ...
      void main() {
        ...
        vec3 gradient2 = vec3(0.0, 0.44, 0.95); // Electric Blue
        vec3 gradient1 = vec3(0.0, 0.66, 0.83); // Neon Teal
